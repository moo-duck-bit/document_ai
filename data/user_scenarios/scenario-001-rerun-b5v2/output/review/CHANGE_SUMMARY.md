...
- Req. 203 → SKIPPED_WITH_REASON: Design ownership not evidenced for this CR: same-ID/theme-like overlap without CR↔design object/action alignment (cr_mddr=[], mdsr_mddr=['등록', '마인드리움', '환자']).
